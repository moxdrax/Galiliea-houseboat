    ...
    return (
        <main className="flex-grow relative overflow-hidden flex items-start justify-center pt-32 md:pt-48 pb-32">
            ...
            <div className="relative z-10 max-w-2xl px-6 text-center">
                <h1 className="font-serif text-[120px] md:text-[200px] leading-none text-royal-blue opacity-90 select-none">404
                </h1>
                <div className="space-y-6 mt-8 md:mt-12">
                    <h2 className="text-3xl md:text-5xl font-light text-royal-blue italic">Lost in the Backwaters?</h2>
